    ...
    <section className="relative h-screen text-center lg:text-start">
      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-10">
        <div className="max-w-2xl text-white">
          <h1 className="text-[35px] lg:text-5xl md:text-6xl mb-6">
          ...
          <div className="flex lg:flex-row flex-col justify-center lg:justify-start items-center gap-4 mt-8">
          ...
          <div className="absolute hidden  bottom-5 w-2/3 left-5 lg:flex  mt-8">
          ...
          <div className="absolute bottom-5 px-4 lg:hidden">
            <p className="text-[14px] font-[500] lg:hidden">
